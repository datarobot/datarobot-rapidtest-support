...
2. Prepare a CSV file of new sites with the following columns: `site_name`, `street`, `city`, `county`, `state`, `zip`, `site_type`, `district`, `clia`, `contact_name`, `contact_phone`, `contact_email`, `latitude`, `longitude`. Click **Download a template file** to use a template with the column names pre-populated.
