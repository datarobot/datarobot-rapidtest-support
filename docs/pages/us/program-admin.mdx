...
To manage test operators, click either the **Test Operators** tab. The _Manage Accounts_ page displays a list of all active and inactive test operators with their name, email, date they were added, and status.
