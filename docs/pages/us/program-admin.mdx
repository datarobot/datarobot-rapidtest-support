...
2. Select the site and click to disable the toggle in the Status column.

    ![Deactivate site](images/admin-site-7.png)

If you deactivated the wrong site, select the site and click again to enable the Status toggle.
